...
| Performance analysis (MongoDB + Redis audit) | ✅ Done | Jul 1, 2026 |
| Dev ingress: unified + APIM aligned (5 IPs released) | ✅ Done | Jun 26, 2026 |
| Dev secrets migrated from configmaps to Key Vault (CSI) | ✅ Done | Jun 26, 2026 |
| Dev ELK stack removed (90 GiB freed) | ✅ Done | Jun 26, 2026 |
| Dev image tags: `dev-{SHA}` (traceability + rollback) | ✅ Done | Jun 26, 2026 |
| Dev AKS upgraded 1.33.0 → 1.34.8 | ✅ Done | Jun 26, 2026 |
| Staging MongoDB indexes (22 Claims + 5 IntHub) | ✅ Done | Jul 1, 2026 |
| Staging IntHub K8s fixes (env, probes, resources) | ✅ Done | Jul 1, 2026 |
| Staging Claims HPA min=2, memory 1Gi/2Gi | ✅ Done | Jul 7, 2026 |
| Staging Quotation HPA min=2, resources added | ✅ Done | Jul 7, 2026 |
| Dev ingress proxy-body-size: 10m → 15m | ✅ Done | Jul 3, 2026 |
| CI/CD: Workflow standardized (6 repos x 4 branches, golden standard) | ✅ Done | Jul 10, 2026 |
| CI/CD: Prod environment validation guardrail added | ✅ Done | Jul 9, 2026 |
| CI/CD: workflow-trigger-guard removed (caused 15min stalls) | ✅ Done | Jul 10, 2026 |
| CI/CD: Invoice prod environment vars created (12 vars) | ✅ Done | Jul 9, 2026 |
| Prod: K8S_SERVICE_IP_PROD fixed (external → internal 10.0.1.62) | ✅ Done | Jul 9, 2026 |
| Prod: MongoDB CSI secret sync fixed (stale credentials) | ✅ Done | Jul 9, 2026 |
| Prod: IntHub APIM serviceUrl restored to internal IP | ✅ Done | Jul 9, 2026 |
