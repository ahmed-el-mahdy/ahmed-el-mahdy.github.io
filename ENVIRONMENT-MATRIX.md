...
| **Replicas per service** | 1 (HPA max 2) | 2 (HPA max 3) | 2 Claims/Quotation, 1 others (HPA max 4) | 1-4 (HPA autoscaled) |
...
|-----------|-----|-----|---------|------|
| **APIM** | recovery-api-management-dev | recovery-api-management-qa | recovery-api-management-staging | Recovery-apim-v2-prod |
| **APIM SKU** | Developer | Developer | Developer | StandardV2 |
| **App Gateway** | ❌ | ❌ | ❌ | ✅ WAF_v2 |
| **Firewall** | ❌ | ❌ | ❌ | ✅ Azure Firewall |
| **Bastion** | ❌ | ❌ | ❌ | ✅ Standard |
| **Ingress** | dev-unified-ingress (dev ns) | qa-unified-ingress (qa ns) | ❌ (LoadBalancer per svc) | prod-unified-ingress (prod ns) |
| **Ingress body-size** | 15m | default | N/A | default |
| **Network Policies** | ❌ | ❌ | ❌ | ❌ |
...
| **Key Vault** | ❌ (secrets in configmap) | ✅ Recovery-keyvault-qa | ✅ Recovery-keyvault-staging | ✅ Recovery-keyvault-prod (CSI sync fixed Jul 9) |
...
| **APIM Import** | ✅ | ✅ | ✅ | ✅ (internal IP 10.0.1.62) |
| **Workflow Standardized** | ✅ Golden standard | ✅ Golden standard | ✅ Golden standard | ✅ Golden standard |
| **Prod Validation Guard** | ✅ | ✅ | ✅ | ✅ |
| **Trigger Guard** | Removed (Jul 10) | Removed (Jul 10) | Removed (Jul 10) | N/A |
...
| 2 | ~~No staging ingress~~ | ~~Services unreachable via path-based routing~~ | Staging uses direct LoadBalancer per service (no ingress) | 1h | ✅ **By Design** |
